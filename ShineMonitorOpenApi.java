...
public class ShineMonitorOpenApi
{
    ...
    /** Authentication interface. */
        private static final void auth()
        {
            ...
            String usr = "nazir abida" ;
            String pwd = "ali ali ali" ;
            ...
            String action = "&action=authSource&usr=" + usr;
            ...
            //String request = ShineMonitorOpenApi.OPEN_API_URI + "?sign=" + sign + "&salt=" + salt + "&action=authSource&usr=nazir+abida" + "&company-key=" + companyKey + "&i18n=en_US&lang=en_US&source=1&_app_client_=android&_app_id_=wifiapp.volfw.watchpower&_app_version_=1.2.0.0";
            //b0b6bc8e31d6e2f6d8b883677821dade7983f23a
            String request = "http://android.shinemonitor.com/public/?sign=" + sign + "&salt=1692449911453&action=authSource&usr=nazir+abida&company-key=bnrl_frRFjEz8Mkn&i18n=en_US&lang=en_US&source=1&_app_client_=android&_app_id_=wifiapp.volfw.watchpower&_app_version_=1.2.0.0";
